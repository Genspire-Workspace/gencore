// file: packages/ai/src/application/prompts/ai-prompt-renderer.ts
...
import type { IAiMessage } from "../../domain/messages/ai-message.js";
import type {
  IAiPrompt,
  IAiPromptRenderInput,
  IAiPromptVariable,
  IAiRenderedPrompt,
} from "../../domain/prompts/ai-prompt.js";
