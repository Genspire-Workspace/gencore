...
export const DEFAULT_SESSION_TITLE_PROMPT_NAME = "Session Title Generation Prompt";
export const DEFAULT_SESSION_SYSTEM_PROMPT_TYPE = "system_prompt";
export const DEFAULT_SESSION_TITLE_PROMPT_TYPE = "chat_title_generation";
