// file: packages/ai/src/providers/openai-compatible/openai-compatible-chat-generator.ts
...
} from "../../application/tools/ai-tool-utils.js";
import { applyModelTransform } from "../../application/model-transforms/index.js";
